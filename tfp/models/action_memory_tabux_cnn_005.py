...
from .action_memory_cnn_003 import ActionMemoryCNN003
from .tabux_controller import TabuXController

MODEL_SPEC = {
    "key": "action_memory_tabux_cnn_005",
    "display_name": "Action-Memory CNN + TabuX 005",
    "algorithm": "ppo",
    "recurrent": False,
...
class ActionMemoryTabuXCNN005(ActionMemoryCNN003):

...
class RouteContextEncoder(nn.Module):
    ...
    FOX-RM-L3 channels 0..5 are spatial (walls, doors, object, goal, agent). Channels
    ...
    def __init__(self, observation_shape: tuple[int, int, int], feature_dim: int = 128) -> None:
        ...
        if channels < 14:
            raise ValueError("FOX-RM-L3 route models require the 14-channel room observation.")
